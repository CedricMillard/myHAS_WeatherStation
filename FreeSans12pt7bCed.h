...
const uint8_t FreeSans12pt7bBitmaps[] PROGMEM = {
  ...
  0x62, 0x31, 0x88, 0xC4, 0x62, 0x00, 0x38, 0xFB, 0xBE, 0x3E, 0xEF, 0x8E, 
  ...
  0x8C, 0x63, 0x0C, 0x33, 0x31, 0x8C, 0x63, 0x18, 0xC6, 0x73, 0x00, 0x70, 
  0x3E, 0x09, 0xE4, 0x1F, 0x03, 0x80
};
...
const GFXglyph FreeSans12pt7bGlyphs[] PROGMEM = {
  ...
  {   174,   7,   7,   9,    2,  -17 },   // 0x2A '°' but use * to type in
